...
export default function Navbar({ lang, setLang }) {
  ...
  return (
    ...
    <nav className={`fixed top-0 left-0 w-full z-50 backdrop-blur-xl transition-all duration-500 ${

      scrolled 

        ? 'bg-black/60 border-b border-white/10 shadow-2xl' 
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <a href="#inicio" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col animate-float">
            ...
            <span className="text-xs font-light tracking-widest text-gray-400 group-hover:text-cyan-300 transition-all duration-300 font-sans">
        ...
        <ul className="hidden md:flex gap-8 items-center font-sans">
          ...
          <li className="relative">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/10 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20 ${
